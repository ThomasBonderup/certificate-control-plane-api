...
public record CreateAssetRequest(
    ...
    @NotBlank
    String name,
    @Schema(description = "Operational asset classification.", example = "BROKER")
    @NotNull
    AssetType assetType,
    @Schema(description = "Deployment environment or ring.", example = "prod-eu-west")
    String environment,
    @Schema(description = "Network hostname for the asset, when available.", example = "broker-01.example.com")
    String hostname,
